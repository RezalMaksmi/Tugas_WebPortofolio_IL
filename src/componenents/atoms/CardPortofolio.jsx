...
import bumdes from "../../assets/portofolio/bumdes.png";
import kopi from "../../assets/portofolio/kopi.png";
    ...
    <div className="grid xl:grid-cols-3 md:grid-cols-2 grid-cols-1 overflow-y-scroll py-3 px-3 md:gap-8 gap-4 justify-start  w-full">
      <div className="flex flex-col  p-2 gap-3 rounded-lg relative">
        ...
        <div className="flex flex-col text-white absolute bottom-0 backdrop-blur-sm p-3 bg-[#1e1e1e86]">
          <h5 className="text-2xl">Bumdes</h5>
          <span className="text-sm ">
            Pengelolaan Data Excel Berbasis Website
          </span>
          <span className="text-sm ">Role : Frontend</span>
          ...
          <a
            href="https://bumdestirtomajubersama.com/"
            className="text-white text-base px-3 py-1 bg-[#707070] absolute  top-0 right-0 rounded-sm"
          >
            <BiLinkExternal />
          </a>
        </div>
      ...
      <div className="flex flex-col  p-2 gap-3 rounded-lg relative">
        ...
        />
        <div className="flex flex-col text-white absolute bottom-0 backdrop-blur-sm p-3 bg-[#1e1e1e86]">
          <h5 className="text-2xl">HinggaPagi</h5>
          <span className="text-sm ">Website HinggaPagi - fastwork</span>
          <span className="text-sm ">Role : Frontend</span>
